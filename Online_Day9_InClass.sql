...
select first_name,age,survived from titanic_ds where survived=1;

#Q3. Display the age, first_name, last_name and pclass of those passengers where pclass is 1 or 2.

select age,first_name,last_name,pclass from titanic_ds where pclass in (1,2);

#Q4. Display the first_name, last_name, passenger_no of the passenger who paid the maximum fare.
# Display the maximum fair paid by the passenger as well

select first_name,last_name,passenger_no,max(fare) from titanic_ds where fare=(select max(fare) from titanic_ds);

#Q5. Display the survived status of all the male passengers.

select first_name,survived from titanic_ds where sex='male';

#Q6. Display the passenger_no, first_name, last_name and embark_town of those passenger
# where embark_town should not contain any word ending with ‘rg’.

select passenger_no,first_name,last_name,embark_town from titanic_ds where embark_town not like '%rg';
...
select deck,first_name,last_name,age from titanic_ds where age between 20 and 35;
...
end as cat,age from titanic_ds;
